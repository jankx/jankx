    ...
    public function boot(Application $app)
    {
        ...
        if (!is_admin()) {
            ...
            $coreLayoutCss = "
                ...
                .is-flex-container.columns-1 > * { flex: 0 0 100%; max-width: 100%; }
                .is-flex-container.columns-2 > * { flex: 0 0 calc(50% - var(--jankx-grid-gap, 1.5rem) / 2); max-width: calc(50% - var(--jankx-grid-gap, 1.5rem) / 2); }
                .is-flex-container.columns-3 > * { flex: 0 0 calc(33.333% - var(--jankx-grid-gap, 1.5rem) * 2 / 3); max-width: calc(33.333% - var(--jankx-grid-gap, 1.5rem) * 2 / 3); }

                /* Mobile override — chỉ override khi < 768px */
                @media (max-width: 767px) {
                    .is-flex-container.columns-mobile-1 > * { flex: 0 0 100%; max-width: 100%; }
                    .is-flex-container.columns-mobile-2 > * { flex: 0 0 calc(50% - var(--jankx-grid-gap, 1.5rem) / 2); max-width: calc(50% - var(--jankx-grid-gap, 1.5rem) / 2); }
                    .is-flex-container.columns-mobile-3 > * { flex: 0 0 calc(33.333% - var(--jankx-grid-gap, 1.5rem) * 2 / 3); max-width: calc(33.333% - var(--jankx-grid-gap, 1.5rem) * 2 / 3); }
                    .is-flex-container.columns-mobile-4 > * { flex: 0 0 calc(25% - var(--jankx-grid-gap, 1.5rem) * 3 / 4); max-width: calc(25% - var(--jankx-grid-gap, 1.5rem) * 3 / 4); }
                }        
            ";
