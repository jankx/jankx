 ...
 */
?>
<div class="<?php echo esc_attr(implode(' ', (array)$carousel_classes)); ?>" style="position: relative;"
    <?php foreach ($data_attributes as $key => $value) : ?>
        data-<?php echo esc_attr($key); ?>="<?php echo esc_attr($value); ?>"
    <?php endforeach; ?>>

    <?php if ($show_arrows): ?>
        <button class="carousel-nav carousel-arrow carousel-arrow-prev" style="<?php echo esc_attr($prev_style); ?>" aria-label="<?php esc_attr_e('Previous slide', 'jankx'); ?>">
        ...
        <button class="carousel-nav carousel-arrow carousel-arrow-next" style="<?php echo esc_attr($next_style); ?>" aria-label="<?php esc_attr_e('Next slide', 'jankx'); ?>">
            <span class="carousel-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    <?php if ($show_dots): ?>
        <div class="carousel-dots" style="<?php echo esc_attr($dots_style); ?>"></div>
    <?php endif; ?>
</div>
