...
class ViewPromotionalBannerLayout extends AbstractViewLayout
{
    protected $name = 'promotional-banner';
    protected $title = 'Promotional Banner Layout';
    ...
    {
        $classes[] = 'promotional-banner-wrapper';
        return parent::appendClassesToWrapper($classes, $options);
    }
}
