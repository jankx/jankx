...
class TypographyBlock extends Block
{
     ...
     */
    private const INTERNAL_CSS = '.jankx-typography-block > *, .wp-block-jankx-typography > *{font-size:var(--jankx-font-size-desktop,initial);display:-webkit-box;-webkit-box-orient:vertical;overflow:hidden;text-overflow:ellipsis;-webkit-line-clamp:var(--jankx-line-clamp-desktop,initial);line-clamp:var(--jankx-line-clamp-desktop,initial)}@media(max-width:1024px){.jankx-typography-block > *, .wp-block-jankx-typography > *{font-size:var(--jankx-font-size-tablet,var(--jankx-font-size-desktop,initial));-webkit-line-clamp:var(--jankx-line-clamp-tablet,var(--jankx-line-clamp-desktop,initial));line-clamp:var(--jankx-line-clamp-tablet,var(--jankx-line-clamp-desktop,initial))}}@media(max-width:768px){.jankx-typography-block > *, .wp-block-jankx-typography > *{font-size:var(--jankx-font-size-mobile,var(--jankx-font-size-tablet,var(--jankx-font-size-desktop,initial)));-webkit-line-clamp:var(--jankx-line-clamp-mobile,var(--jankx-line-clamp-tablet,var(--jankx-line-clamp-desktop,initial)));line-clamp:var(--jankx-line-clamp-mobile,var(--jankx-line-clamp-tablet,var(--jankx-line-clamp-desktop,initial)))}}';
