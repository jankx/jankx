...
class SwiperSlider extends Block
{
    public function __construct()
    {
        parent::__construct('jankx/swiper-slider', [
            ...
            'category' => 'jankx',
            'icon' => 'slides',
            'description' => __('Advanced Swiper slider with full customization options', 'jankx'),
            'keywords' => ['slider', 'carousel', 'banner', 'swiper', 'slideshow'],
            'supports' => [
                'html' => false,
                'align' => ['wide', 'full'],
                'spacing' => [
    ...
    public function render($attributes, $content = '')
    {
        ...
        $slides = $this->parse_slides($content);

        // Build Swiper configuration
        $swiper_config = $this->build_swiper_config($attributes);

        // Enqueue Swiper assets
        $this->enqueue_swiper_assets($effect);
    ...
    protected function parse_slides($content)
    {
        $slides = [];
    ...
    protected function build_swiper_config($attributes)
    {
        $config = [
    ...
    protected function enqueue_swiper_assets($effect)
    {
        // Enqueue Swiper core
        wp_enqueue_script(
            'swiper-core',
