...
class ConfigCommand extends WP_CLI_Command
{
    ...
    protected function showNextSteps()
    {
        ...
        WP_CLI::log('  2. Modify the config files as needed for your child theme');
        WP_CLI::log('  3. Test your child theme configuration');
        WP_CLI::log('  4. Clear cache if needed: wp jankx cache clear-config');
        WP_CLI::log('');
