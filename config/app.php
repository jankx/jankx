...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This option controls the default cipher that will be used to encrypt
    | values. You may change the default cipher as you see fit for your
    | application.
    |
    */
    'cipher' => 'AES-256-CBC',
    ...
    */
    'providers' => [
        ...
        \Jankx\Config\ConfigServiceProvider::class,
    ...
    */
    'aliases' => [
        ...
        'Logger' => \Jankx\Facades\Logger::class,
    ],
];