...
import { bindWindowListeners, unbindWindowListeners, onViewportChange, suggested as suggestPosition, constrainLeft, offset, } from './util';
import './style.scss';
const noop = () => { };
class PopoverInner extends Component {
    ...
    computePosition() {
        ...
        const reposition = Object.assign({}, constrainLeft(offset(suggestedPosition, domContainer, domContext, relativePosition), domContainer, this.props.ignoreViewportSize), { positionClass: this.getPositionClass(suggestedPosition) });
        return reposition;
    }
    setPosition = () => {
        let position;
    ...
    render() {
        ...
        return (_jsxs("div", { ref: this.popoverNodeRef, "aria-label": this.props['aria-label'], id: this.props.id, role: "tooltip", tabIndex: "-1", style: this.getStylePosition(), className: classes, onMouseEnter: this.handleOnMouseEnter, onMouseLeave: this.handleOnMouseLeave, children: [!this.props.hideArrow ? _jsx("div", { className: "popover__arrow" }) : null, _jsx("div", { ref: this.popoverInnerNodeRef, className: "popover__inner", children: this.props.children })] }));
    }
}
...
function Popover({ isVisible = false, showDelay = 0, hideArrow = false, ...props }) {
    ...
    return (_jsx(RootChild, { children: _jsx(PopoverInner, { ...props, isRtl: isRtl, hideArrow: hideArrow }) }));
}
