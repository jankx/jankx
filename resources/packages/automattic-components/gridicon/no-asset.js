...
const Gridicon = React.memo(React.forwardRef((props, ref) => {
    ...
    return (_jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", className: iconClass, height: size, width: size, ref: ref, ...otherProps, children: [title && _jsx("title", { children: title }), _jsx("use", { xlinkHref: `#${iconName}` })] }));
}));
Gridicon.displayName = 'Gridicon';
export default Gridicon;
//# sourceMappingURL=no-asset.js.map