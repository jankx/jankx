...
const PremiumBadge = ({ className, labelText: customLabelText, tooltipContent, tooltipClassName, tooltipPosition = 'bottom left', isPremiumThemeAvailable, shouldCompactWithAnimation, shouldHideIcon, shouldHideTooltip, focusOnShow, isClickable, }) => {
    ...
    return (_jsxs("div", { className: clsx('premium-badge', className, {
        ...
        }, ...isClickableProps, children: [!shouldHideIcon && (_jsx(_Fragment, { children: _jsx(Gridicon, { className: "premium-badge__logo", icon: "star", size: 14 }) })), _jsx("span", { className: "premium-badge__label", ref: labelRef, children: labelText }), !shouldHideTooltip && (_jsx(Popover, { className: clsx('premium-badge__popover', tooltipClassName), context: divRef.current, isVisible: isPopoverVisible, position: tooltipPosition, focusOnShow: focusOnShow, children: tooltipContent || tooltipText })), displayLabelAsTooltip && (_jsx(Popover, { className: clsx('premium-badge__popover', tooltipClassName), context: divRef.current, isVisible: isPopoverVisible, position: "bottom", focusOnShow: focusOnShow, children: labelText }))] }));
};
