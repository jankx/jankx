...
const Template = (args) => {
    ...
    return (_jsx("div", { style: { position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }, children: _jsx(CountCard, { heading: args.heading, icon: _jsx(Icon, { icon: institution }), value: value }) }));
};
...
//# sourceMappingURL=count-card.stories.js.map