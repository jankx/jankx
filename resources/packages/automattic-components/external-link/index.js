 ...
 */
function ExternalLink({ className, icon = false, iconSize = 18, showIconFirst = false, iconClassName, iconComponent = null, localizeUrl: shouldLocalizeUrl = true, children, ...rest }) {
    ...
    const iconEl = iconComponent || (_jsx(Gridicon, { className: iconClassName, icon: "external", size: iconSize }));
    return (_jsxs("a", { ...linkProps, children: [icon && showIconFirst && iconEl, children, icon && !showIconFirst && iconEl, icon && (_jsx(ScreenReaderText, { children: translate('(opens in a new tab)', {
