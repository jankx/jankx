...
function createMessengerItem(m, positionX, idleAnimation) {
...
function getItemTranslate(index, cfg) {
...
document.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('.jankx-floating-messengers').forEach(el => {
    try {
