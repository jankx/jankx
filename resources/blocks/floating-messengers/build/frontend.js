...
/*!************************************************!*\
  ...
  \************************************************/
function initFloatingMessengers(container) {
  const positionX = container.getAttribute('data-position-x');
  const positionY = container.getAttribute('data-position-y');
  const expansionStyle = container.getAttribute('data-expansion-style');
  const idleAnimation = container.getAttribute('data-idle-animation');
  ...
  const itemsWrapper = container.querySelector('.fm-items');
  const itemEls = Array.from(container.querySelectorAll('.fm-item'));
  const mainBtn = container.querySelector('.fm-main-button');
  ...
  let isOpen = false;
  function getItemTransform(index, count) {
  ...
  function applyIdleAnimation(el) {
...
function boot() {
  const containers = Array.from(document.querySelectorAll('.jankx-floating-messengers'));
