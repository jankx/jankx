...
function Edit({
  ...
  const parentDefaults = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
    const {
      getBlockParents,
      getBlock
