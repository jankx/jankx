...
(function () {
  ...
  function initCarousel(root) {
    ...
    carousels.forEach(carousel => {
      ...
      const plugins = instance.autoplay ? [(0,embla_carousel_autoplay__WEBPACK_IMPORTED_MODULE_1__["default"])({
        delay: instance.autoplayDelay,
        stopOnInteraction: true,
        stopOnMouseEnter: true
      })] : [];
      instance.embla = (0,embla_carousel__WEBPACK_IMPORTED_MODULE_0__["default"])(container, {
        loop: true,
        duration: 25,
        align: 'start'
      }, plugins);
      ...
      if (instance.autoplay) {
        const ap = instance.embla.plugins?.().autoplay;
        if (ap) {
          carousel.addEventListener('mouseenter', () => ap.stop(), {
            passive: true
          });
          carousel.addEventListener('mouseleave', () => ap.play(), {
            passive: true
          });
          carousel.addEventListener('touchstart', () => ap.stop(), {
            passive: true
          });
          carousel.addEventListener('touchend', () => ap.play(), {
            passive: true
          });
        }
      }
