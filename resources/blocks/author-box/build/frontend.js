...
(function () {
  ...
  class AuthorBoxFrontend {
    ...
    renderAuthor(author) {
      ...
      // Build CSS classes
      const cssClasses = ['jankx-author-box', 'jankx-author-box--' + (this.config.layout || 'horizontal'), 'jankx-author-box--align-' + (this.config.textAlign || 'left')];
