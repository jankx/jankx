...
function initDynamicDataCarousel(root) {
  const carousels = root ? root.querySelectorAll('.wp-block-jankx-dynamic-data-layout[data-layout="carousel"]') : document.querySelectorAll('.wp-block-jankx-dynamic-data-layout[data-layout="carousel"]');
  carousels.forEach(carousel => {
    ...
    const embla = (0,embla_carousel__WEBPACK_IMPORTED_MODULE_0__["default"])(container, {
      loop: loop,
      duration: 25,
      align: 'start'
    }, plugins);
