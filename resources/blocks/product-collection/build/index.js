...
const PRODUCT_COLLECTION_BLOCK_NAME = _block_json__WEBPACK_IMPORTED_MODULE_1__.name;
...
const DEFAULT_ATTRIBUTES = {
    ...
    tagName: 'div',
    displayLayout: {
        type: _types__WEBPACK_IMPORTED_MODULE_2__.LayoutOptions.GRID,
        columns: 3,
        shrinkColumns: true
    },
    dimensions: {
        widthType: _types__WEBPACK_IMPORTED_MODULE_2__.WidthOptions.FILL
    },
...
const ProductPicker = props => {
    ...
    const infoText = isDeletedProductReference ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Previously selected product is no longer available.', 'woocommerce') : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.createInterpolateElement)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.sprintf)(/* translators: %s: collection title */ (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('<strong>%s</strong> requires a product to be selected in order to display associated items.', 'woocommerce'), collection.title), {
...
const CollectionButton = ({ title, icon, description, onClick }) => {
...
const GridCollectionOptions = props => {
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
                ...
                children: collectionVariations.map(({ name, title, icon, description }) => /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(CollectionButton, {
                    title: title,
...
const DropdownCollectionOptions = props => {
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Dropdown, {
                ...
                renderToggle: ({ isOpen, onToggle }) => /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
                    variant: "secondary",
                    onClick: onToggle,
...
const CollectionChooser = props => {
    ...
    const blockCollections = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(select => {
        // @ts-expect-error Type definitions are missing
        // https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/wordpress__blocks/store/selectors.d.ts
        const { getBlockVariations } = select(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__.store);
        return getBlockVariations(_block_json__WEBPACK_IMPORTED_MODULE_7__.name);
    }, []);
    const productCatalog = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => blockCollections.find(({ name }) => name === _types__WEBPACK_IMPORTED_MODULE_6__.CoreCollectionNames.PRODUCT_CATALOG), [blockCollections]);
    const collectionVariations = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => blockCollections.filter(({ name, scope }) => {
    ...
    const [resizeListener, { width }] = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_3__.useResizeObserver)();
...
const PatternSelectionModal = props => {
    const { clientId, attributes, tracksLocation, closePatternSelectionModal } = props;
    ...
    const { replaceBlock } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useDispatch)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.store);
...
const Edit = props => {
    ...
    const { productCollectionUIStateInEditor, isLoading } = (0,_utils__WEBPACK_IMPORTED_MODULE_9__.useProductCollectionUIState)({
        location,
        attributes,
        hasInnerBlocks,
...
const useHasUnsupportedBlocks = clientId => (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.useSelect)(select => {
    ...
    const { getClientIdsOfDescendants, getBlockName } = select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.store);
...
const AttributesControl = ({ query, trackInteraction, setQueryAttribute }) => {
    ...
    const deselectCallback = () => {
        setQueryAttribute({
            woocommerceAttributes: _constants__WEBPACK_IMPORTED_MODULE_4__.DEFAULT_FILTERS.woocommerceAttributes
        });
        trackInteraction(_types__WEBPACK_IMPORTED_MODULE_3__.CoreFilterNames.ATTRIBUTES);
    };
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.__experimentalToolsPanelItem, {
        ...
        children: [/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@woocommerce/editor-components/product-attribute-term-control'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
                messages: {
...
const HandPickedProductsControlField = ({ query, trackInteraction, setQueryAttribute }) => {
    ...
    const { productsMap, productsList, productsLoaded } = useProducts(isLargeCatalog, searchQuery, selectedProductIds);
...
const HandPickedProductsControl = ({ query, trackInteraction, setQueryAttribute }) => {
    const selectedProductIds = query.woocommerceHandPickedProducts;
    const deselectCallback = () => {
        setQueryAttribute({
...
const shouldDisplayUpgradeNotice = props => {
    ...
    const { status, time, displayCount } = Object(function webpackMissingModule() { var e = new Error("Cannot find module '@woocommerce/blocks/migration-products-to-product-collection'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
...
const ProductButton = ({ isOpen, onToggle, product, isLoading }) => {
...
const LinkedProductPopoverContent = ({ query, setAttributes, setIsDropdownOpen }) => /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@woocommerce/editor-components/product-control'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
...
const LinkedProductControl = ({ query, setAttributes, location, usesReference }) => {
    ...
    const { product, isLoading } = (0,_utils__WEBPACK_IMPORTED_MODULE_5__.useGetProduct)(productReference);
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
        ...
        children: [showRadioControl && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelRow, {
                ...
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Dropdown, {
                    ...
                    renderToggle: ({ isOpen, onToggle }) => /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(ProductButton, {
                        isOpen: isOpen,
                        onToggle: onToggle,
                        product: product,
                        isLoading: isLoading
...
const MaxPagesToShowControl = ({ query, setQueryAttribute, trackInteraction }) => {
    const deselectCallback = () => {
        setQueryAttribute({
...
const OffsetControl = ({ query, setQueryAttribute, trackInteraction }) => {
    const deselectCallback = () => {
        setQueryAttribute({
...
const DefaultQueryOrderByControl = ({ trackInteraction }) => {
...
const OrderByControl = ({ hasValue = () => true, orderOptions, onChange, onDeselect = () => void 0, selectedValue, label, help }) => {
...
const PriceTextField = ({ value, onChange, label }) => {
...
const ProductsPerPageControl = ({ query, setQueryAttribute, trackInteraction, carouselVariant }) => {
    const deselectCallback = () => {
        setQueryAttribute({
...
const RelatedByControl = ({ query, setQueryAttribute, trackInteraction }) => {
...
const useTaxonomies = () => {
    const taxonomies = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(select => {
        const { getTaxonomies } = select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_2__.store);
...
function TaxonomyControls({ setQueryAttribute, trackInteraction, query, collection, renderMode = 'panel' }) {
    const { filteredTaxonomies, taxQuery, createHandleChange, shouldShowTaxonomyControl } = (0,_use_taxonomy_controls__WEBPACK_IMPORTED_MODULE_5__["default"])({
        query,
        collection,
        setQueryAttribute,
        trackInteraction,
...
const TaxonomyItem = ({ taxonomy, termIds, onChange }) => {
    ...
    const { existingTerms, isLoadingExistingTerms } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(select => {
    ...
    const [searchQuery, setSearchQuery] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)('');
    const { searchTerms } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(select => {
 ...
 */
function useTaxonomyControls({ setQueryAttribute, trackInteraction, query, collection, isFiltersPanel }) {
...
const UpgradeNotice = ({ revertMigration }) => {
...
const useCarouselLayoutAdjustments = (clientId, attributes) => {
    ...
    const { productCollectionBlock } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(select => ({
...
const InheritQueryControl = ({ setQueryAttribute, trackInteraction, query }) => {
...
const FilterableControl = ({ setQueryAttribute, trackInteraction, query }) => {
...
const WidthOptionsControl = ({ dimensions, setAttributes }) => {
...
const useQueryId = (clientId, attributes, ProductCollectionContent) => {
    ...
    const { getBlockParentsByBlockName } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.store);
...
const ProductCollectionContent = ({ preview: { setPreviewState, initialPreviewState } = {}, ...props }) => {
    const isInitialAttributesSet = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useRef)(false);
    const { clientId, attributes, setAttributes, location, isUsingReferencePreviewMode } = props;
...
const ProductCollectionPlaceholder = props => {
    ...
    // @ts-expect-error Type definitions for this function are missing
    // https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/wordpress__blocks/store/actions.d.ts
    const { replaceBlock } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useDispatch)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.store);
...
function QuerySave({ attributes: { tagName: Tag = 'div' } }) {
...
const isFirstBlockThatUsesPageContext = property => {
    ...
    const { getBlocksByName, getBlock } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.select)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.store);
...
const useProductCollectionUIState = ({ location, usesReference, attributes, hasInnerBlocks }) => {
    ...
    const { product, hasResolved } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(selectFunc => {
        if (!productReference) {
            return {
                product: null,
                hasResolved: true
        ...
        const { getEntityRecord, hasFinishedResolution } = selectFunc(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_3__.store);
...
const useSetPreviewState = ({ setPreviewState, location, attributes, setAttributes, isUsingReferencePreviewMode }) => {
...
function registerElementVariation(coreName, { blockDescription, blockIcon, blockTitle, variationName, scope }) {
