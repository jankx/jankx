...
/***/ "./blocks/categories-grid/block.json":
/*!*******************************************!*\
  !*** ./blocks/categories-grid/block.json ***!
  \*******************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"jankx/categories-grid","version":"1.0.0","title":"Categories Grid for WooCommerce","category":"widgets","icon":"grid-view","description":"Display WooCommerce categories in a grid with popup with product loading.","supports":{"html":false,"interactivity":{"clientNavigation":true},"color":{"background":true,"text":true},"shadow":true,"spacing":{"margin":true,"padding":true},"__experimentalBorder":{"radius":true,"color":true,"width":true,"style":true,"__experimentalDefaultControls":{"color":true,"radius":true}}},"attributes":{"catsPerRow":{"type":"number","default":3},"productCategories":{"type":"array","default":[]}},"example":{"attributes":{"catsPerRow":"2","productCategories":[{"id":"1","name":"Cat 1"},{"id":"2","name":"Cat 2"},{"id":"3","name":"Cat 3"},{"id":"4","name":"Cat 4"}]}},"textdomain":"jankx","editorScript":"file:./build/index.js","viewScript":"file:./build/view.js","editorStyle":"file:./build/editor.css","style":"file:./build/style.css"}');
...
/* harmony import */ var _shared_components__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../shared/components */ "./shared/components/index.tsx");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./blocks/categories-grid/block.json");
...
const Edit = ({ attributes, setAttributes }) => {
    ...
    const handleChange = selected => {
        const selectedArray = selected.map(id => {
            const name = categoryOptions.find(opt => {
        ...
        setAttributes({
            productCategories: selectedArray
        });
    };
    const resetAll = () => {
        setAttributes({
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
        ...blockProps,
        children: [/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_5__.InspectorGroups.Settings, {
                useToolsPanel: true,
                resetAll: resetAll,
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_5__.InspectorToolsPanelItem, {
                    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Categories per row', 'jankx'),
            ...
            }), /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_5__.CommonPanels.Settings, {
                initialOpen: false,
                children: categories ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
                    multiple: true,
                    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Choose categories', 'jankx'),
                    value: selectedIds,
                    options: categoryOptions,
                    onChange: selected => {
                        handleChange(Array.isArray(selected) ? selected.map(Number).map(String) : [String(selected)]);
                    }
                }) : /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("p", {
                    children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Loading categories…', 'jankx')
                })
            }), /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
                className: "jankx-categories-wrapper",
                children: productCategories.length ? productCategories.map(cat => /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
                    className: "jankx-category-item",
                    children: [/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
                            className: "jankx-category-image",
                            children: cat.imageUrl ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("img", {
                                src: cat.imageUrl,
                                alt: cat.name
                            }) : /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
                                className: "jankx-category-placeholder",
                                children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('No Image', 'jankx')
                            })
                        }), /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("h4", {
                            children: cat.name
                        })]
                }, cat.id)) : /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("p", {
                    children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Please select categories…', 'jankx')
                })
            })]
    });
};
