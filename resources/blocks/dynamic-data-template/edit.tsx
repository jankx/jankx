            ...
            <div {...blockProps}>
                {displayLayout === 'carousel' ? (
                    <div className={`dynamic-data-template__carousel columns-${columns}`}>
                        ...
                        >
                            <div
                                className={`dynamic-data-template__items-container jankx-post-ratio-${clientId} layout-${displayLayout} columns-${columns} columns-tablet-${columnsTablet} columns-mobile-${columnsMobile}`}
                                style={{
                ...
                {getItemBgRatioMediaStyles(attributes, '.jankx-post-ratio-' + clientId) && (
                    <style dangerouslySetInnerHTML={{ __html: getItemBgRatioMediaStyles(attributes, '.jankx-post-ratio-' + clientId) }} />
                )}
            </div>
        </>
    );
