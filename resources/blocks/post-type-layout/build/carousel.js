...
(() => {
/*!*********************************************!*\
  !*** ./blocks/post-type-layout/carousel.ts ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
...
function initCarousels() {
  ...
  carouselContainers.forEach(container => {
    ...
    const slidesToScroll = parseInt(container.getAttribute('data-slides-to-scroll') || '1', 10);
    const loop = container.getAttribute('data-loop') === 'true';
    const autoplay = container.getAttribute('data-autoplay') === 'true';
    const autoplayDelay = parseInt(container.getAttribute('data-autoplay-delay') || '3000', 10);
    ...
    const embla = (0,embla_carousel__WEBPACK_IMPORTED_MODULE_0__["default"])(viewport, emblaOptions);
