    ...
    /******/ var __webpack_modules__ = ({
        ...
        /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            ...
            const Edit = ({ attributes, setAttributes, clientId }) => {
                ...
                const { insertBlock } = (0, _wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useDispatch)('core/block-editor');
                const { getBlockIndex, getBlockRootClientId } = (0, _wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => select('core/block-editor'));
