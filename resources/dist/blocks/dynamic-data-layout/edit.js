...
function Edit({ attributes, setAttributes, clientId }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(InspectorControls, { group: "settings", children: [_jsxs(PanelBody, { title: __('Query Settings', 'jankx'), initialOpen: true, children: [_jsx(SelectControl, { label: __('Query Preset', 'jankx'), value: queryPreset, options: queryPresetOptions, onChange: (value) => {
                                ...
                                } })) : null] }), settingsDefinition.length > 0 && (_jsx(PanelBody, { title: __('Layout Settings', 'jankx'), initialOpen: true, children: settingsDefinition.map((setting, index) => renderSettingsControl(setting, index)) })), queryPreset === 'custom' ? (_jsxs(PanelBody, { title: __('Query Parameters', 'jankx'), initialOpen: false, children: [_jsx(RangeControl, { label: __('Offset', 'jankx'), value: offset, onChange: (value) => setAttributes({ offset: value || 0 }), min: 0, max: 50, help: __('Skip the first N posts', 'jankx') }), (orderBy === 'meta_value' || orderBy === 'meta_value_num') ? (_jsxs(_Fragment, { children: [_jsx(TextControl, { label: __('Meta Key', 'jankx'), value: metaKey, onChange: (value) => setAttributes({ metaKey: value }), help: __('Meta key for sorting (required when using meta_value)', 'jankx'), placeholder: __('Example: price, views, rating', 'jankx') }), orderBy === 'meta_value' ? (_jsx(SelectControl, { label: __('Meta Type', 'jankx'), value: metaType, options: window.jankxQueryOptions?.metaTypes || [
                    ...
                    if (!hasTemplateBlock) {
                        return (_jsxs("div", { style: {
                                ...
                                backgroundColor: '#f0f6fc',
                                        ...
                                        fontWeight: '600',
                                    }, children: __('Add Dynamic Data Template to define item layout', 'jankx') }), _jsx(InnerBlocks, { allowedBlocks: ['jankx/dynamic-data-template'], templateLock: false, renderAppender: InnerBlocks.ButtonBlockAppender })] }));
                    }
                    return (_jsx(InnerBlocks, { allowedBlocks: ['jankx/dynamic-data-template'], templateLock: false, renderAppender: InnerBlocks.DefaultBlockAppender }));
                })() })] }));
}
export default Edit;
