...
describe('LanguageSwitcher Frontend', () => {
    ...
    it('should initialize dropdown functionality', () => {
        ...
        const button = container.querySelector('.language-switcher-dropdown');
        const menu = container.querySelector('.language-switcher-dropdown-menu');
    ...
    it('should handle language link clicks', () => {
        initLanguageSwitcher();
        const link = container.querySelector('.language-dropdown-link');
