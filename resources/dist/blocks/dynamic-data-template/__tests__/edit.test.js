...
jest.mock('@wordpress/block-editor', () => ({
    ...
    BlockPreview: () => _jsx("div", { "data-testid": "block-preview" }),
...
jest.mock('@wordpress/components', () => ({
    PanelBody: ({ title, children, initialOpen }) => (_jsxs("div", { "data-testid": `panel-${title}`, children: [_jsx("button", { children: title }), children] })),
