...
import { PanelBody, SelectControl, ToggleControl, RangeControl, TextControl, Button, ButtonGroup, Tooltip, FocalPointPicker, } from '@wordpress/components';
 ...
 */
const buildItemBackgroundStyle = (attributes) => {
    const styles = {};
 ...
 */
const buildItemBackgroundOverlayStyle = (attributes) => {
    const styles = {};
...
export default function Edit({ attributes, setAttributes, clientId, context, }) {
    ...
    const queryArgs = useMemo(() => {
        ...
        if (context.authorIn?.length)
            args.author = context.authorIn.join(',');
        if (context.authorNotIn?.length)
            args.author_exclude = context.authorNotIn.join(',');
        if (context.postIn?.length)
            args.include = context.postIn.join(',');
        if (context.postNotIn?.length)
            args.exclude = context.postNotIn.join(',');
        if (context.postParent)
            args.parent = context.postParent;
        if (context.postParentIn?.length)
            args.parent = context.postParentIn.join(',');
        if (context.postParentNotIn?.length)
            args.parent_exclude = context.postParentNotIn.join(',');
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(InspectorControls, { children: [_jsxs(PanelBody, { title: __('Template Settings', 'jankx'), initialOpen: true, children: [_jsxs("div", { className: "jankx-layout-chooser", children: [_jsx("label", { className: "jankx-layout-chooser__label", children: __('Content Loop Layout', 'jankx') }), _jsx(ButtonGroup, { className: "jankx-layout-chooser__group", children: [
                            ...
                            ], onChange: (value) => setAttributes({ thumbnailPosition: value }), help: __('Choose where the featured image appears relative to the content.', 'jankx') }) }), _jsxs(PanelBody, { title: __('Item Background', 'jankx'), initialOpen: false, children: [_jsx(SelectControl, { label: __('Background Type', 'jankx'), value: itemBgType, options: [
                                    { label: __('None', 'jankx'), value: 'none' },
                                    { label: __('Color', 'jankx'), value: 'color' },
                                    { label: __('Image', 'jankx'), value: 'image' },
                                ], onChange: (value) => setAttributes({ itemBgType: value }) }), itemBgType === 'color' && (_jsxs("div", { className: "components-base-control", children: [_jsx("label", { className: "components-base-control__label", children: __('Background Color', 'jankx') }), _jsx("div", { className: "components-color-palette-control__color-indicator-wrapper", children: _jsx("input", { type: "color", value: itemBgColor || '#ffffff', onChange: (e) => setAttributes({ itemBgColor: e.target.value }), style: { width: '100%', height: '40px' } }) })] })), itemBgType === 'image' && (_jsxs(_Fragment, { children: [_jsx(SelectControl, { label: __('Image Source', 'jankx'), value: itemBgImageSource, options: [
                                            { label: __('Custom Image', 'jankx'), value: 'custom' },
                                            { label: __('Featured Image', 'jankx'), value: 'featured' },
                                        ], onChange: (value) => setAttributes({ itemBgImageSource: value }) }), itemBgImageSource === 'custom' && (_jsx(MediaUpload, { onSelect: (media) => {
                                            setAttributes({
                                                itemBgImageId: media?.id || 0,
                                                itemBgImageUrl: media?.url || '',
                                            });
                                        }, allowedTypes: ['image'], value: itemBgImageId || 0, render: ({ open }) => (_jsx(Button, { variant: "secondary", onClick: open, style: { marginBottom: 8 }, children: itemBgImageUrl ? __('Change Background Image', 'jankx') : __('Select Background Image', 'jankx') })) })), itemBgImageSource === 'custom' && itemBgImageUrl && (_jsxs("div", { style: { marginBottom: 8 }, children: [_jsx("img", { src: itemBgImageUrl, alt: "", style: { maxWidth: '100%', height: 'auto', borderRadius: 4 } }), _jsx(Button, { variant: "secondary", onClick: () => setAttributes({ itemBgImageUrl: '', itemBgImageId: 0 }), style: { marginTop: 8 }, children: __('Remove Image', 'jankx') })] })), itemBgImageSource === 'featured' && (_jsx("p", { className: "components-base-control__help", children: __('Will use each item\'s featured image as background.', 'jankx') })), _jsx(SelectControl, { label: __('Background Size', 'jankx'), value: itemBgSize, options: [
                                            { label: __('Cover', 'jankx'), value: 'cover' },
                                            { label: __('Contain', 'jankx'), value: 'contain' },
                                            { label: __('Auto', 'jankx'), value: 'auto' },
                                        ], onChange: (value) => setAttributes({ itemBgSize: value }) }), _jsx(SelectControl, { label: __('Background Repeat', 'jankx'), value: itemBgRepeat, options: [
                                        ...
                                        ], onChange: (value) => setAttributes({ itemBgRepeat: value }) }), _jsxs("div", { className: "components-base-control", children: [_jsx("label", { className: "components-base-control__label", children: __('Background Position', 'jankx') }), _jsx(FocalPointPicker, { value: itemBgPosition, onChange: (value) => setAttributes({ itemBgPosition: value }), dimensions: { width: 100, height: 100 }, url: itemBgImageUrl || undefined, style: { width: '100%', height: 120 } })] }), _jsxs("div", { className: "components-base-control", children: [_jsx("label", { className: "components-base-control__label", children: __('Overlay Color', 'jankx') }), _jsx("div", { className: "components-color-palette-control__color-indicator-wrapper", children: _jsx("input", { type: "color", value: itemBgOverlay || '#000000', onChange: (e) => setAttributes({ itemBgOverlay: e.target.value }), style: { width: '100%', height: '40px' } }) }), _jsx("p", { className: "components-base-control__help", children: __('Optional color overlay on top of background image.', 'jankx') })] })] }))] })] }), _jsxs(InspectorControls, { children: [_jsxs(PanelBody, { title: __('Overlay Icon Settings', 'jankx'), initialOpen: true, children: [_jsx(SelectControl, { label: __('Overlay Source', 'jankx'), value: (overlayIconType || 'class'), options: [
                                ...
                                overflow: 'hidden',
                                    ...
                                    if (index === 0) {
                                        return (_jsxs("div", { className: `dynamic-data-template__item ${animationClass}`, "data-item-index": index, style: itemStyle, children: [itemBgType === 'image' && itemBgOverlay && (_jsx("div", { style: buildItemBackgroundOverlayStyle(attributes) })), postData ? (_jsx(BlockContextProvider, { value: contextValue, children: _jsx("div", { ...innerBlocksProps }) })) : (_jsx("div", { ...innerBlocksProps }))] }, `item-${index}`));
                                    }
                                    return (_jsxs("div", { className: `dynamic-data-template__item dynamic-data-template__item--preview ${animationClass}`, "data-item-index": index, style: itemStyle, children: [itemBgType === 'image' && itemBgOverlay && (_jsx("div", { style: buildItemBackgroundOverlayStyle(attributes) })), postData ? (_jsx(BlockContextProvider, { value: contextValue, children: _jsx(PreviewItem, { index: index, blocks: sharedInnerBlocks, templateItemStyle: buildTemplateItemStyle(attributes), templateItemClassName: buildTemplateItemClasses(attributes) }) })) : (_jsx(PreviewItem, { index: index, blocks: sharedInnerBlocks, templateItemStyle: buildTemplateItemStyle(attributes), templateItemClassName: buildTemplateItemClasses(attributes) }))] }, `item-${index}`));
                        ...
                        if (index === 0) {
                            ...
                            return (_jsxs("div", { className: `dynamic-data-template__item ${animationClass}`, "data-item-index": index, "data-hover-ani": hoverAnimation !== 'none' ? hoverAnimation : undefined, "data-unhover-ani": unhoverAnimation !== 'none' ? unhoverAnimation : undefined, style: itemStyle2, children: [itemBgType === 'image' && itemBgOverlay && (_jsx("div", { style: buildItemBackgroundOverlayStyle(attributes) })), postData ? (_jsx(BlockContextProvider, { value: contextValue, children: _jsx("div", { ...innerBlocksProps }) })) : (_jsx("div", { ...innerBlocksProps }))] }, `item-${index}`));
                        }
                        const itemStyle3 = {};
                        ...
                        return (_jsxs("div", { className: `dynamic-data-template__item dynamic-data-template__item--preview ${animationClass}`, "data-item-index": index, "data-hover-ani": hoverAnimation !== 'none' ? hoverAnimation : undefined, "data-unhover-ani": unhoverAnimation !== 'none' ? unhoverAnimation : undefined, style: itemStyle3, children: [itemBgType === 'image' && itemBgOverlay && (_jsx("div", { style: buildItemBackgroundOverlayStyle(attributes) })), postData ? (_jsx(BlockContextProvider, { value: contextValue, children: _jsx(PreviewItem, { index: index, blocks: sharedInnerBlocks, templateItemStyle: buildTemplateItemStyle(attributes), templateItemClassName: buildTemplateItemClasses(attributes) }) })) : (_jsx(PreviewItem, { index: index, blocks: sharedInnerBlocks, templateItemStyle: buildTemplateItemStyle(attributes), templateItemClassName: buildTemplateItemClasses(attributes) }))] }, `item-${index}`));
                    }) })) })] }));
}
