...
describe('SocialSharing Frontend', () => {
    ...
    it('should handle Facebook share button click', (done) => {
        ...
        document.dispatchEvent(event);
        setTimeout(() => {
            const facebookButton = container.querySelector('[data-network="facebook"]');
            if (facebookButton) {
    ...
    it('should handle Twitter share button click', (done) => {
        ...
        document.dispatchEvent(event);
        setTimeout(() => {
            const twitterButton = container.querySelector('[data-network="twitter"]');
            if (twitterButton) {
                twitterButton.click();
    ...
    it('should handle copy link button click', async () => {
        ...
        const copyButton = container.querySelector('[data-network="copy"]');
        if (copyButton) {
            copyButton.click();
    ...
    it('should handle Pinterest share button click', (done) => {
        ...
        document.dispatchEvent(event);
        setTimeout(() => {
            const pinterestButton = container.querySelector('[data-network="pinterest"]');
            if (pinterestButton) {
