 ...
 */
import { ALLOWED_INNER_BLOCKS, VALIDATION_RULES } from './constants';
/**
 * Validate block content including attributes and inner blocks
 */
export const validateBlockContent = (attributes, innerBlocks = []) => {
    const issues = [];
 ...
 */
export const validateInnerBlocks = (innerBlocks = []) => {
    const issues = [];
 ...
 */
export const isAllowedInnerBlock = (blockName) => {
    return ALLOWED_INNER_BLOCKS.includes(blockName);
};
/**
 * Validate specific block attributes
 */
export const validateBlockAttributes = (blockName, attributes) => {
    const issues = [];
 ...
 */
export const validateAnimationSettings = (animation, duration, delay) => {
    const issues = [];
 ...
 * Validate overlay settings
 */
export const validateOverlaySettings = (overlaySettings) => {
    const issues = [];
    // Validate position
