...
export function parseIcon(icon) {
    ...
    const parseOptions = {
        ...
        replace: ({ attribs, children, name, parent, type }) => {
            ...
            if ((type !== 'tag' && type !== 'style') || // Allow svg and style tags.
            ...
            if (type === 'style' && name === 'style' && children) {
                ...
                if (children[0]?.data) {
                    return (_jsx(Tag, { ...attributesToProps(attribs), children: children[0].data }));
                }
                return _jsx(_Fragment, {});
            }
            ...
            return (_jsx(Tag, { ...attributesToProps(attribs), style: parseStyles(attribs?.style), children: domToReact(children, parseOptions) }));
        },
    };
