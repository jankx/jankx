 ...
 */
import { parseUploadedMediaAndSetIcon, parseDroppedMediaAndSetIcon, displayMessages, } from './../../utils';
export default function IconDropZone(props) {
        ...
        if (isSVGUploadAllowed) {
            mediaUpload({
                ...
                onFileChange([image]) {
                    ...
                    parseUploadedMediaAndSetIcon(image, attributes, setAttributes);
                },
                onError() {
    ...
    return _jsx(DropZone, { label: label, onFilesDrop: onDropFiles });
}
