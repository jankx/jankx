...
export default function Save(props) {
    ...
    const iconMarkup = (_jsx(_Fragment, { children: linkUrl ? (_jsx("a", { className: iconClasses, href: linkUrl, target: target, rel: rel, style: iconStyles, "aria-label": label ? label : null, children: printedIcon })) : (_jsx("div", { className: iconClasses, style: iconStyles, children: printedIcon })) }));
    return (_jsx("div", { ...useBlockProps.save({
        ...
        style: blockMargin, title: title, children: iconMarkup }));
}
