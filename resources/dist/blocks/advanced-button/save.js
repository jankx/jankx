 ...
 */
import { useBlockProps, RichText, InnerBlocks, __experimentalGetBorderClassesAndStyles as getBorderClassesAndStyles, } from '@wordpress/block-editor';
/**
...
export default function Save(props) {
    ...
    const textMarkup = (_jsxs(_Fragment, { children: [_jsx("span", { className: "button-icon-wrapper", children: _jsx(InnerBlocks.Content, {}) }), showLabel && (_jsx(RichText.Content, { tagName: "span", className: "button-text", value: sanitizedText }))] }));
    // Render button element based on trigger type
    let buttonElement = null;
    switch (triggerType) {
        case 'link':
            buttonElement = (_jsx("a", { className: buttonClasses, href: url || '#', target: linkTarget || undefined, rel: rel || undefined, style: buttonStyles, title: title, "data-condition-type": conditionType, "data-show-for-post-type": showForPostType || undefined, "data-trigger-type": "link", children: textMarkup }));
            break;
        case 'button':
            buttonElement = (_jsx("button", { className: buttonClasses, type: buttonType, style: buttonStyles, title: title, "data-condition-type": conditionType, "data-show-for-post-type": showForPostType || undefined, "data-trigger-type": "button", children: textMarkup }));
            break;
        case 'detail-link':
            // href="#" will be replaced by PHP with actual permalink
            buttonElement = (_jsx("a", { className: buttonClasses + ' jankx-button-detail-link', href: "#", "data-trigger-type": "detail-link", "data-condition-type": conditionType, "data-show-for-post-type": showForPostType || undefined, style: buttonStyles, title: title, children: textMarkup }));
            break;
        case 'modal':
            ...
            buttonElement = (_jsx("button", { className: buttonClasses + (modalId ? ' jankx-button-modal-trigger' : ''), type: "button", ...modalDataAttrs, style: buttonStyles, title: title, children: textMarkup }));
            break;
        default:
            buttonElement = (_jsx("a", { className: buttonClasses, href: "#", style: buttonStyles, title: title, "data-trigger-type": "link", children: textMarkup }));
    }
    return (_jsx("div", { ...blockProps, children: buttonElement }));
}
