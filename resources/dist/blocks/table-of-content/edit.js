...
export default function Edit({ attributes, setAttributes, clientId }) {
    const { listingType, expandIconType, defaultExpanded, expandFirstItem, showHeading, hideEmptyMessage, customHeadingText, headingStyle, minHeadingLevel, maxHeadingLevel, } = attributes;
