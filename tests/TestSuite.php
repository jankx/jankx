...
class JankxTestSuite extends TestSuite
{
    public static function suite()
    {
        ...
        $suite->addTestSuite(\Tests\Kernel\KernelManagerTest::class);
        ...
        $suite->addTestSuite(\Tests\Facades\FacadeTest::class);
        $suite->addTestSuite(\Tests\Context\ContextualServiceRegistryTest::class);
