/******/ (() => { // webpackBootstrap
/*!************************************************!*\
  !*** ./gallery/blocks/gallery-detail/index.js ***!
  \************************************************/
;
(function (wp) {
  if (!wp || !wp.blocks) {
  ...
  var __ = wp.i18n.__;
  var useBlockProps = wp.blockEditor && wp.blockEditor.useBlockProps ? wp.blockEditor.useBlockProps : function () {
    return {};
  };
  ...
  function Edit(props) {
    var blockProps = useBlockProps({
      className: 'jankx-gallery-detail-editor'
    });
    var a = props.attributes;
    function setAttr(key) {
      return function (value) {
        props.setAttributes((t = {}, t[key] = value, t));
        var t;
      };
    }
    var inspector = InspectorControls ? el(InspectorControls, {}, el(PanelBody, {
      title: __('Source', 'jankx'),
      initialOpen: true
    }, el(ToggleControl, {
    ...
    if (ServerSideRender) {
      ...
      useEffect(function () {
        ...
        apiFetch({
          ...
          setHtml(out || '');
          setTimeout(function () {
            var evt = new CustomEvent('jankx:gallery:refresh', {
              detail: {}
            });
      ...
      preview = el('div', Object.assign({}, blockProps, {
        className: (blockProps.className || '') + ' jankx-gallery-detail-editor'
      }), el('div', {
