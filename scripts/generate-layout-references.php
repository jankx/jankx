...
if (!function_exists('get_template_directory')) {
    function get_template_directory() { return dirname(dirname(__FILE__)); }
}
...
if (!function_exists('register_block_type_from_metadata')) {
    function register_block_type_from_metadata($path, $args = array()) { return true; }
}
...
if (!function_exists('clean_post_cache')) {
    function clean_post_cache($id) { return; }
}
...
require_once __DIR__ . '/../tests/Gutenberg/Layouts/LayoutReferenceGenerator.php';

use Jankx\Gutenberg\Layouts\LayoutReferenceGenerator;

try {
    $outputDir = __DIR__ . '/../tests/Gutenberg/fixtures/layouts/output-references';
    if (!is_dir($outputDir)) {
